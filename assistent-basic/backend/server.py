...
async def process_text(request: NewsRequest):
    ...
    results = {}
    results.update(pluralisme_analysis(request.text))
    results.update(diversitat_analysis(request.text))
    results.update(minories_analysis(request.text))
    results.update(paritat_analysis(request.text))
    results.update(compromis_analysis(request.text))
    results.update(veracitat_analysis(request.text))
    results.update(imparcialitat_analysis(request.text))
